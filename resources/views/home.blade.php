...
<head>
  ...
  <meta name="keywords" content="" />
    ...
    <link href="{{ asset('assets/css/vendor/icomoon/style.css') }}" rel="stylesheet">
  ...
  <body>
    ...
    <div class="untree_co--site-wrap">
      ...
      <nav class="untree_co--site-nav js-sticky-nav">
        <div class="container d-flex align-items-center">
          <div class="logo-wrap">
            <a href="index.html" class="untree_co--site-logo">LuxtonHotel</a>
          </div>
    ...
    <script src="{{ asset('assets/js/vendor/jquery.lettering.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/jquery.sticky.js') }}"></script>

    <script src="{{ asset('assets/js/vendor/TweenMax.min.js') }}"></script>
    <script src="{{ asset('assets/js/vendor/ScrollMagic.min.js') }}"></script>
