<div class="untree_co--site-wrap">
    ...
    @if (Request::is('profil','tentangkami'))
            ...
            <div class="site-nav-ul-wrap text-center d-none d-lg-block">
                <ul class="site-nav-ul js-clone-nav">
                    ...
                    <li class="has-children">
                        ...
                        <ul class="dropdown">
                            <li><a href="#" class="@if (Request::is('profil','tentangkami')) text-dark @endif">Standard</a></li>
                            <li><a href="#" class="@if (Request::is('profil','tentangkami')) text-dark @endif">Superior</a></li>
                            <li><a href="#" class="@if (Request::is('profil','tentangkami')) text-dark @endif">Deluxe</a></li>
                            <li><a href="#" class="@if (Request::is('profil','tentangkami')) text-dark @endif">Executive</a></li>
                        </ul>
                    </li>
                    <li>
