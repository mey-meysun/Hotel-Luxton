...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        Route::get('/laporan', [LaporanController::class, 'laporanBulanan'])->name('laporan.bulanan');
    ...
    Route::middleware('customer')->group(function () {
        ...
        Route::delete('/reservations/{id}', [ReservationController::class, 'batal'])->name('reservations.batal'); // Hapus reservasi
...
Route::get('/tipekamar', [RoomController::class, 'index'])->name('rooms.index');
